...
- Remote KV is pushed via `scripts/cloudflare/push-seeds-kv.mjs`
...
```bash
node scripts/cloudflare/push-seeds-kv.mjs --account-id <cf-account-id> --namespace-id <kv-namespace-id>
```
...
node scripts/cloudflare/push-seeds-kv.mjs \
