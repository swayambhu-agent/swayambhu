...
- Your wake hook code — the entire policy layer that governs what happens when you wake up (session flow, reflection, modification protocol, protection gates)
